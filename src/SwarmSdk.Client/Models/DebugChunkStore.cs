...
{
    public record DebugChunkStore(
        DebugChunkStoreUpload Upload,
        DebugChunkStorePinning Pinning,
        DebugChunkStoreCache Cache,
        DebugChunkStoreReserve Reserve,
        DebugChunkStoreChunkStore ChunkStore);
}