...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        internal LastCashedChequeDto(Clients.DebugApi.V3_0_2.LastCashedCheque lastCashedCheque)
        {
        ...
        internal LastCashedChequeDto(Clients.GatewayApi.V3_0_2.LastCashedCheque lastCashedCheque)
        {
            if (lastCashedCheque is null)
                throw new ArgumentNullException(nameof(lastCashedCheque));
