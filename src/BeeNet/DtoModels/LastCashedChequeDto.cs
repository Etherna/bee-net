...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        public LastCashedChequeDto(Clients.DebugApi.V4_0_0.LastCashedCheque lastCashedCheque)
        {
        ...
        public LastCashedChequeDto(Clients.GatewayApi.V4_0_0.LastCashedCheque lastCashedCheque)
        {
            if (lastCashedCheque is null)
                throw new ArgumentNullException(nameof(lastCashedCheque));
