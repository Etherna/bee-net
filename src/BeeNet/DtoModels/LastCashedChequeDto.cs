...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        internal LastCashedChequeDto(Clients.DebugApi.V5_0_0.LastCashedCheque lastCashedCheque)
        {
        ...
        internal LastCashedChequeDto(Clients.GatewayApi.V5_0_0.LastCashedCheque lastCashedCheque)
        {
            if (lastCashedCheque is null)
                throw new ArgumentNullException(nameof(lastCashedCheque));
