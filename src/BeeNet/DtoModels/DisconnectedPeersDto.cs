...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        internal DisconnectedPeersDto(Clients.DebugApi.V3_2_0.DisconnectedPeers disconnectedPeers)
        {
        ...
        internal DisconnectedPeersDto(Clients.GatewayApi.V3_2_0.DisconnectedPeers disconnectedPeers)
        {
            if (disconnectedPeers is null)
                throw new ArgumentNullException(nameof(disconnectedPeers));
