...
namespace Etherna.BeeNet.DtoModels
{
    public class NodeInfoDto
    {
        ...
        internal NodeInfoDto(Clients.GatewayApi.V4_0_0.Response32 response)
        {
            if (response is null)
                throw new ArgumentNullException(nameof(response));
            ...
            BeeMode = response.BeeMode switch
            {
                Clients.GatewayApi.V4_0_0.Response32BeeMode.Dev => BeeModeDto.Dev,
                Clients.GatewayApi.V4_0_0.Response32BeeMode.Full => BeeModeDto.Full,
                Clients.GatewayApi.V4_0_0.Response32BeeMode.Light => BeeModeDto.Light,
                _ => throw new InvalidOperationException()
            };
            ChequebookEnabled = response.ChequebookEnabled;
            SwapEnabled = response.SwapEnabled;
