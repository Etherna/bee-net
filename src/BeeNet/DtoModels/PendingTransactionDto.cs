...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        internal PendingTransactionDto(Clients.DebugApi.V5_0_0.PendingTransactions tx)
        {
            if (tx is null)
        ...
        internal PendingTransactionDto(Clients.GatewayApi.V5_0_0.PendingTransactions tx)
        {
            if (tx is null)
                throw new ArgumentNullException(nameof(tx));
