...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        internal LastReceivedDto(Clients.DebugApi.V3_0_2.Lastreceived lastReceived)
        {
        ...
        internal LastReceivedDto(Clients.DebugApi.V3_0_2.Lastreceived2 lastReceived)
        {
            if (lastReceived is null)
                throw new ArgumentNullException(nameof(lastReceived));
        ...
        internal LastReceivedDto(Clients.GatewayApi.V3_0_2.Lastreceived lastReceived)
        {
            if (lastReceived is null)
                throw new ArgumentNullException(nameof(lastReceived));
        ...
        internal LastReceivedDto(Clients.GatewayApi.V3_0_2.Lastreceived2 lastReceived)
        {
            if (lastReceived is null)
                throw new ArgumentNullException(nameof(lastReceived));
