...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        internal LastReceivedDto(Clients.DebugApi.V5_0_0.Lastreceived lastReceived)
        {
        ...
        internal LastReceivedDto(Clients.DebugApi.V5_0_0.Lastreceived2 lastReceived)
        {
            if (lastReceived is null)
                throw new ArgumentNullException(nameof(lastReceived));
        ...
        internal LastReceivedDto(Clients.GatewayApi.V5_0_0.Lastreceived lastReceived)
        {
            if (lastReceived is null)
                throw new ArgumentNullException(nameof(lastReceived));
        ...
        internal LastReceivedDto(Clients.GatewayApi.V5_0_0.Lastreceived2 lastReceived)
        {
            if (lastReceived is null)
                throw new ArgumentNullException(nameof(lastReceived));
