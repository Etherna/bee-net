...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        public LastReceivedDto(Clients.DebugApi.V4_0_0.Lastreceived lastReceived)
        {
        ...
        public LastReceivedDto(Clients.DebugApi.V4_0_0.Lastreceived2 lastReceived)
        {
            if (lastReceived is null)
                throw new ArgumentNullException(nameof(lastReceived));
        ...
        public LastReceivedDto(Clients.GatewayApi.V4_0_0.Lastreceived lastReceived)
        {
            if (lastReceived is null)
                throw new ArgumentNullException(nameof(lastReceived));
        ...
        public LastReceivedDto(Clients.GatewayApi.V4_0_0.Lastreceived2 lastReceived)
        {
            if (lastReceived is null)
                throw new ArgumentNullException(nameof(lastReceived));
