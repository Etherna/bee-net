...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        internal LastSentDto(Clients.DebugApi.V3_0_2.Lastsent lastsent)
        {
            if (lastsent is null)
        ...
        internal LastSentDto(Clients.DebugApi.V3_0_2.Lastsent2 lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
        ...
        internal LastSentDto(Clients.GatewayApi.V3_0_2.Lastsent lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
        ...
        internal LastSentDto(Clients.GatewayApi.V3_0_2.Lastsent2 lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
