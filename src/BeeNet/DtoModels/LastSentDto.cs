...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        public LastSentDto(Clients.DebugApi.V4_0_0.Lastsent lastsent)
        {
            if (lastsent is null)
        ...
        public LastSentDto(Clients.DebugApi.V4_0_0.Lastsent2 lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
        ...
        public LastSentDto(Clients.GatewayApi.V4_0_0.Lastsent lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
        ...
        public LastSentDto(Clients.GatewayApi.V4_0_0.Lastsent2 lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
