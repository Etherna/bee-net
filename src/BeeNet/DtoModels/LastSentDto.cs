...
namespace Etherna.BeeNet.DtoModels
{
    ...
    {
        // Constructors.
        public LastSentDto(Clients.DebugApi.V1_2_0.Lastsent lastsent)
        {
            if (lastsent is null)
        ...
        public LastSentDto(Clients.DebugApi.V1_2_0.Lastsent2 lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
        ...
        public LastSentDto(Clients.DebugApi.V1_2_1.Lastsent2 lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
        ...
        public LastSentDto(Clients.DebugApi.V1_2_1.Lastsent lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
        ...
        public LastSentDto(Clients.DebugApi.V2_0_0.Lastsent lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
        ...
        public LastSentDto(Clients.GatewayApi.V3_0_2.Lastsent lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
        ...
        public LastSentDto(Clients.GatewayApi.V3_0_2.Lastsent2 lastsent)
        {
            if (lastsent is null)
                throw new ArgumentNullException(nameof(lastsent));
