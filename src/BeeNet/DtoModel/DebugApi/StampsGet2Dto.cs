...
namespace Etherna.BeeNet.DtoModel.Debug
{
    ...
    {
        public StampsGet2Dto(bool exists, int batchTTL, object batchID, int utilization, bool usable, string label, int depth, string amount, int bucketDepth, int blockNumber, bool immutableFlag, IDictionary<string, object> additionalProperties)
