...
{
    public class WelcomeMessagePostDto : BaseDto
    {
        public WelcomeMessagePostDto(string status, string version, string apiVersion, string debugApiVersion, IDictionary<string, object> additionalProperties)
