...
{
    public interface IBeeGatewayApiClient
    {
        ...
        System.Threading.Tasks.Task<AuthDto> AuthAsync(BodyDto body, System.Threading.CancellationToken? cancellationToken);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Refresh the auth token - This endpoint is experimental</summary>
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<RefreshDto> RefreshAsync(BodyDto body, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<BytesPostDto> BytesPOSTAsync(int? swarmTag, bool? swarmPin, bool? swarmEncrypt, string swarmPostageBatchId, System.IO.Stream body, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ChunksPostDto> ChunksPOSTAsync(int? swarmTag, bool? swarmPin, string swarmPostageBatchId, System.IO.Stream body, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task StreamAsync(int? swarmTag, bool? swarmPin, string swarmPostageBatchId, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<BzzPostDto> BzzPOSTAsync(string name, int? swarmTag, bool? swarmPin, bool? swarmEncrypt, string contentType, bool? swarmCollection, string swarmIndexDocument, string swarmErrorDocument, string swarmPostageBatchId, IEnumerable<FileParameterDto> file, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<TagsGetDto> TagsGETAsync(int? offset, int? limit, System.Threading.CancellationToken? cancellationToken);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Create Tag</summary>
        /// <returns>New Tag Info</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<TagsPostDto> TagsPOSTAsync(Body3Dto body, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<TagsGet2Dto> TagsGET2Async(int uid, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<TagsPatchDto> TagsPATCHAsync(int uid, Body3Dto body, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PinsPostDto> PinsPOSTAsync(string reference, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PinsDeleteDto> PinsDELETEAsync(string reference, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PinsGet2Dto> PinsGET2Async(System.Threading.CancellationToken? cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task SendAsync(string topic, string targets, string recipient, string swarmPostageBatchId, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SocDto> SocAsync(string owner, string id, string sig, bool? swarmPin, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <returns>Created</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<FeedsPostDto> FeedsPOSTAsync(string owner, string topic, string type, bool? swarmPin, string swarmPostageBatchId, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<FeedsGetDto> FeedsGETAsync(string owner, string topic, int? at, string type, System.Threading.CancellationToken? cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<StewardshipGetDto> StewardshipGETAsync(string reference, System.Threading.CancellationToken? cancellationToken);
