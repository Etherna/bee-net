...
namespace Etherna.BeeNet.Clients.GatewayApi
{
    ...
    public partial interface IBeeGatewayClient
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Buy a new postage batch. Be aware, this endpoint create an on-chain transactions and transfers BZZ from the node's Ethereum account and hence directly manipulates the wallet balance!</summary>
        ...
        /// <exception cref="BeeNetGatewayApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Response17> StampsPostAsync(int amount, int depth, string? label = null, long? gas_price = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class BeeGatewayClient : IBeeGatewayClient
    {
        ...
        /// <returns>Returns the newly created postage batch ID</returns>
        /// <exception cref="BeeNetGatewayApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Response17> StampsPostAsync(int amount, int depth, string? label = null, long? gas_price = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (amount == null)
    ...
    public partial class Response5 
    {
        ...
        public long Processed { get; set; }= default!;
