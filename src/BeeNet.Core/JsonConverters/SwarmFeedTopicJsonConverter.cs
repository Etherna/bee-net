...
namespace Etherna.BeeNet.JsonConverters
{
    public sealed class SwarmFeedTopicJsonConverter : JsonConverter<SwarmFeedTopic>
    {
        ...
        public override SwarmFeedTopic ReadAsPropertyName(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void WriteAsPropertyName(Utf8JsonWriter writer, SwarmFeedTopic value, JsonSerializerOptions options)
        {
            ArgumentNullException.ThrowIfNull(writer);
