...
namespace Etherna.BeeNet.JsonConverters
{
    public sealed class EthTxHashJsonConverter : JsonConverter<EthTxHash>
    {
        ...
        public override EthTxHash ReadAsPropertyName(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void WriteAsPropertyName(Utf8JsonWriter writer, EthTxHash value, JsonSerializerOptions options)
        {
            ArgumentNullException.ThrowIfNull(writer, nameof(writer));
