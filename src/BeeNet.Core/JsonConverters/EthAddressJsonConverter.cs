...
namespace Etherna.BeeNet.JsonConverters
{
    public sealed class EthAddressJsonConverter : JsonConverter<EthAddress>
    {
        ...
        public override EthAddress ReadAsPropertyName(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void WriteAsPropertyName(Utf8JsonWriter writer, EthAddress value, JsonSerializerOptions options)
        {
            ArgumentNullException.ThrowIfNull(writer, nameof(writer));
