...
namespace Etherna.BeeNet.JsonConverters
{
    public sealed class PostageBatchIdJsonConverter : JsonConverter<PostageBatchId>
    {
        ...
        public override PostageBatchId ReadAsPropertyName(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void WriteAsPropertyName(Utf8JsonWriter writer, PostageBatchId value, JsonSerializerOptions options)
        {
            ArgumentNullException.ThrowIfNull(writer, nameof(writer));
