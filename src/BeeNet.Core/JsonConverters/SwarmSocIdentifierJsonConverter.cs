...
namespace Etherna.BeeNet.JsonConverters
{
    public sealed class SwarmSocIdentifierJsonConverter : JsonConverter<SwarmSocIdentifier>
    {
        ...
        public override SwarmSocIdentifier ReadAsPropertyName(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void WriteAsPropertyName(Utf8JsonWriter writer, SwarmSocIdentifier value, JsonSerializerOptions options)
        {
            ArgumentNullException.ThrowIfNull(writer, nameof(writer));
